...
e:add_timer(1,1, 1, 3,  function() print("Entity 1 CB 1") end)
--e:add_timer(1,2, 2,  7, function()  print("Entity 1 CB 2")  end)


--
--e:add_transform(2, 200,500)
--e:add_timer(2,1, 0.3, false)
--e:add_timer(3,2, 0.3, false)
